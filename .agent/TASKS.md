...
- [ ] Add horizontal-tab behavior with terminal-owned mutable tab stops, including default stops and resize/reset behavior; do not approximate it as permanently fixed eight-column movement.

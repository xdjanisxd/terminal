...
## Summary
- 1131 nodes · 1813 edges · 112 communities (70 shown, 33 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `90c90b7e`
...
5. `PortablePtySession` - 18 edges
6. `ScreenState` - 17 edges
7. `PtySpawnConfig` - 16 edges
8. `Cell` - 16 edges
9. `assert_observable_state_eq()` - 16 edges
10. `parse_in_chunks()` - 13 edges
...
### Community 0 - "PortablePtySession"
Cohesion: 0.07
Nodes (34): Box, Child, PortableOutputReader, PortablePtyBackend, PortablePtySession, PtyBackend, PtyError, PtyExitStatus (+26 more)

### Community 1 - "CellAttributes"
Cohesion: 0.07
...
### Community 5 - "ScreenSet"
Cohesion: 0.09
Nodes (16): Cell, CellAttributes, Option, Self, SavedCursor, ScreenKind, ScreenSet, ScreenState (+8 more)

### Community 6 - "TerminalState"
Cohesion: 0.06
Nodes (12): AutoWrapMode, CharacterInsertionMode, CellAttributes, TerminalState, CursorKeyMode, CursorVisibility, InputModes, InverseVideo (+4 more)

### Community 7 - "SemanticPerformer"
Cohesion: 0.08
...
### Community 10 - "contract.rs"
Cohesion: 0.16
Nodes (12): PtySession, contains_subsequence(), helper_session(), portable_backend_streams_helper_output_without_assuming_read_boundaries(), contains_subsequence(), drain_until_marker(), naturally_exiting_child_preserves_numeric_exit_status(), output_eof_is_observed_separately_after_child_exit() (+4 more)

### Community 12 - "tests/scrollback.rs"
Cohesion: 0.28
...
### Community 13 - "TerminalModes"
Cohesion: 0.25
Nodes (6): AutoWrapMode, CharacterInsertionMode, CursorKeyMode, CursorVisibility, InputModes, TerminalModes

### Community 14 - ".dimensions"
Cohesion: 0.21
Nodes (5): reset_clears_existing_screen_content(), resize_preserves_overlap_and_blanks_new_cells_through_facade(), CursorError, Self, TerminalDimensions

### Community 15 - "combining_marks.rs"
Cohesion: 0.36
...
### Community 21 - "region_su_sd_parser.rs"
Cohesion: 0.27
...
### Community 23 - "insert_delete_lines.rs"
Cohesion: 0.29
...
### Community 29 - "insert_delete_lines_parser.rs"
Cohesion: 0.29
...
### Community 31 - "screen_resize_scrollback_audit.rs"
Cohesion: 0.35
...
### Community 35 - "dec_alt_screen_1047.rs"
Cohesion: 0.33
...
### Community 36 - "region_nel_parser.rs"
Cohesion: 0.38
...
### Community 39 - "dec_alt_screen_47.rs"
Cohesion: 0.39
...
### Community 41 - "delete_characters.rs"
Cohesion: 0.36
...
### Community 42 - "erase_characters.rs"
Cohesion: 0.36
...
### Community 43 - "insert_characters.rs"
Cohesion: 0.36
...
### Community 44 - "screen_switching.rs"
Cohesion: 0.36
...
### Community 46 - "VerticalScrollingMargins"
Cohesion: 0.29
...
### Community 51 - "erase_characters_parser.rs"
Cohesion: 0.43
...
### Community 52 - "insert_characters_parser.rs"
Cohesion: 0.43
...
### Community 53 - "labeled_scroll_state"
Cohesion: 0.25
...
### Community 54 - "region_ind_ri_parser.rs"
Cohesion: 0.36
...
### Community 55 - "assert_default_cell"
Cohesion: 0.32
...
- **Should `PortablePtySession` be split into smaller, more focused modules?**

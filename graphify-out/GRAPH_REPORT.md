...
## Summary
- 852 nodes · 1294 edges · 78 communities (57 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8dc4f267`
...
9. `state()` - 11 edges
10. `HorizontalTabStops` - 10 edges
...
- `TerminalState` --references--> `PendingReplies`  [EXTRACTED]
  crates/terminal-core/src/state.rs → crates/terminal-core/src/reply.rs
...
Cohesion: 0.06
Nodes (21): AutoWrapMode, CharacterInsertionMode, clear_screen_clears_owned_screen_content(), CursorMovement, EraseDirection, EraseRegion, PrintableWidth, reset_clears_existing_screen_content() (+13 more)

### Community 3 - "ScreenGrid"
Cohesion: 0.11
Nodes (18): delete_cells_shifts_complete_row_cells_left_and_clamps(), labeled_grid(), region_scroll_clamps_counts_and_handles_one_row_regions(), region_scroll_preserves_complete_cells_and_uses_default_exposed_rows(), region_scroll_supports_ranges_touching_either_screen_edge(), row_text(), Cursor, CursorError (+10 more)
...
Cohesion: 0.09
Nodes (10): Cell, CellAttributes, CellColor, CellOccupancy, InverseVideo, ItalicStyle, Default, Self (+2 more)
...
### Community 11 - "assert_observable_state_eq"
Cohesion: 0.28
...
### Community 12 - "region_su_sd_parser.rs"
Cohesion: 0.27
...
### Community 15 - "insert_delete_lines.rs"
Cohesion: 0.29
...
### Community 22 - "TerminalReply"
Cohesion: 0.27
Nodes (5): PendingReplies, Default, Option, TerminalReply, Option
...
### Community 29 - "erase_characters.rs"
Cohesion: 0.36
...
### Community 30 - "insert_characters.rs"
Cohesion: 0.36
...
### Community 37 - "erase_characters_parser.rs"
Cohesion: 0.43
...
### Community 38 - "insert_characters_parser.rs"
Cohesion: 0.43
...
### Community 39 - "labeled_scroll_state"
Cohesion: 0.25
...
### Community 40 - "region_ind_ri_parser.rs"
Cohesion: 0.36
...
### Community 41 - "assert_default_cell"
Cohesion: 0.32
...
### Community 47 - "dsr_status_parser.rs"
Cohesion: 0.43
...
### Community 48 - "Terminal Workspace Application"
Cohesion: 0.29
...
### Community 61 - "Engineering Agent Contract"
Cohesion: 0.40
...
- **Why does `TerminalState` connect `TerminalState` to `ScreenGrid`, `SemanticPerformer`, `CellAttributes`, `region_ind_ri.rs`, `assert_observable_state_eq`, `region_su_sd_parser.rs`, `da1_parser.rs`, `insert_delete_lines.rs`, `region_su_sd.rs`, `rendition.rs`, `scrolling_margins.rs`, `insert_delete_lines_parser.rs`, `region_nel.rs`, `TerminalReply`, `region_nel_parser.rs`, `wide_cells.rs`, `decstbm.rs`, `delete_characters.rs`, `erase_characters.rs`, `insert_characters.rs`, `filled_state`, `da2.rs`, `decckm_parser.rs`, `delete_characters_parser.rs`, `erase_characters_parser.rs`, `insert_characters_parser.rs`, `labeled_scroll_state`, `region_ind_ri_parser.rs`, `assert_default_cell`, `truecolor.rs`, `cpr_parser.rs`, `dsr_status_parser.rs`, `row_text`?**
  _High betweenness centrality (0.515) - this node is a cross-community bridge._
- **Why does `ScreenGrid` connect `ScreenGrid` to `TerminalState`, `CellAttributes`, `TerminalReply`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `TerminalReply` connect `TerminalReply` to `cpr.rs`, `da2.rs`, `cpr_parser.rs`, `da1.rs`, `da1_parser.rs`, `dsr_status_parser.rs`, `dsr_status.rs`, `TerminalReplyBytes`?**

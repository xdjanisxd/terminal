...
- Project-owned `terminal-pty` contract: validated cell size, owned spawn mechanism request, raw-byte output/EOF/exit event representation, project-owned lifecycle/errors, and backend/session traits without real PTY integration or terminal-core coupling

...
- Controlled state operations for cursor movement, margin-aware SU/SD, IND/RI, and NEL, horizontal tabs and tab-stop mutation, vertical scrolling-margin updates, current rendition, clearing, resizing, supported mode changes, and a project-owned reset
...
- Two hundred sixteen `terminal-core` unit/integration tests plus four compile-fail ownership tests
...
- Remaining CSI/SGR style semantics and modes, truecolor and colon-form color semantics, OSC/DCS semantics, terminal replies, saved cursor state, origin mode, and alternate screens
